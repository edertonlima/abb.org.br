		...
		<div class="container">
			...
			<h1>
				<a href="<?php echo get_home_url(); ?>" title="<?php the_field('titulo', 'option'); ?>">
					...
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo.jpg" alt="<?php the_field('titulo', 'option'); ?>">
				</a>
			</h1>
			...
			<nav class="nav">
				<ul class="menu-principal">
					...
					<li class="">
						<a href="#faleconosco" title="Fale Conosco" class="scroll">Fale Conosco</a>
					</li>
				</ul>
			</nav>
